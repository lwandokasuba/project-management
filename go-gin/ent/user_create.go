...
func (uc *UserCreate) AddAssignmentIDs(ids ...uuid.UUID) *UserCreate {
	uc.mutation.AddAssignmentIDs(ids...)
	return uc
}

// AddAssignments adds the "assignments" edges to the Assignment entity.
func (uc *UserCreate) AddAssignments(a ...*Assignment) *UserCreate {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.AssignmentsIDs(); len(nodes) > 0 {
